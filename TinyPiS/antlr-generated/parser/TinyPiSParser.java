...
public class TinyPiSParser extends Parser {
	...
	public static class VarDeclsContext extends ParserRuleContext {
		public List<TerminalNode> IDENTIFIRE() { return getTokens(TinyPiSParser.IDENTIFIRE); }
		public TerminalNode IDENTIFIRE(int i) {
			return getToken(TinyPiSParser.IDENTIFIRE, i);
		}
	...
	public static class AssignStmtContext extends StmtContext {
		public TerminalNode IDENTIFIRE() { return getToken(TinyPiSParser.IDENTIFIRE, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
	...
	public final StmtContext stmt() throws RecognitionException {
		...
		try {
			...
			case T__2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__2) | (1L << T__5) | (1L << T__9) | (1L << IDENTIFIRE))) != 0)) {
					{
					{
					setState(26);
					stmt();
